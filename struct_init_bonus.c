...
/*   Updated: 2022/05/10 17:34:12 by eleotard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_relative_path(t_vars *vars)
{
	...
	vars->img.relative_path6 = "white3.xpm";
}
...
void	ft_img_init(t_vars *vars)
{
	...
	vars->img.bg = mlx_xpm_file_to_image(vars->mlx, vars->img.relative_path6,
			&vars->img.img_width, &vars->img.img_height);
	ft_check_image(vars, vars->img.bg);
}
